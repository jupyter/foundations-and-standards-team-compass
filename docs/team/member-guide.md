...
This page holds resources for members of the Jupyter Foundations and Standards Council.
...
* [**The Jupyter Foundations and Standards Team Compass**](foundations-and-standards-team-compass)
  ...
  etc.
* [**The Jupyter Foundations and Standards Team Compass issues**](foundations-and-standards-team-compass/issues)
...
1. **"Watch" the [`team-compass` repository](foundations-and-standards-team-compass)**
...
2. **Stay up-to-date on team meetings**. You can find a notes from previous meetings pinned at
   the [top of the `team-compass` issues page](foundations-and-standards-team-compass/issues).
...
* **Use your best judgment**. As a member of the Jupyter Foundations and Standards Council, we trust
